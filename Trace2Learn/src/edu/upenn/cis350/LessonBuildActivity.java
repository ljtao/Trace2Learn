...
import edu.upenn.cis350.PhraseActivity.EfficientAdapter;
import edu.upenn.cis350.PhraseActivity.EfficientAdapter.ViewHolder;

public class LessonBuildActivity extends ListActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backButton = (Button)this.findViewById(R.id.back4);
        ...
        saveButton.setOnClickListener(new OnClickListener() {            
            public void onClick(View v) {
            	...
            	lDbHelper.createLesson(tv.getText().toString(), "");
            	tv.setText("");
            }
          });   
